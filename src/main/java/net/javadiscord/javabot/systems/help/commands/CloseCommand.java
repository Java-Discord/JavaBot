...
public class CloseCommand extends UnreserveCommand {
	 ...
	 */
	public CloseCommand(BotConfig botConfig, ScheduledExecutorService asyncPool, DbActions dbActions, HelpExperienceService helpExperienceService) {
		super(botConfig, asyncPool, dbActions, helpExperienceService);
		setSlashCommandData(
