...
public final class Responses {
	...
	public static ReplyCallbackAction success(SlashCommandInteractionEvent event, String title, String message) {
	...
	public static ReplyCallbackAction info(SlashCommandInteractionEvent event, String title, String message) {
		return reply(event, title, message, Bot.config.get(event.getGuild()).getSlashCommand().getInfoColor(), true);
	}
	...
	public static ReplyCallbackAction error(SlashCommandInteractionEvent event, String message) {
	...
	public static ReplyCallbackAction warning(SlashCommandInteractionEvent event, String message) {
	...
	public static ReplyCallbackAction warning(SlashCommandInteractionEvent event, String title, String message) {
	 ...
	 */
	private static ReplyCallbackAction reply(SlashCommandInteractionEvent event, @Nullable String title, String message, Color color, boolean ephemeral) {
